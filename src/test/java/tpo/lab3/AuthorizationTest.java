...
public class AuthorizationTest {
    ...
    public void EmailLoginTest() {
        ...
        driverConfig.getDrivers().values().parallelStream().forEach(driver -> {
            ...
            //filling inputs and click submit btn//*[@id=\"root\"]/div/div[1]/div/div[4]/div[3]/span/div/div/div/a[3]/button
            ...
            String text = getElementByXPath(driver, "//*[@id=\"root\"]/div/div[1]/div/div[4]/div[3]/span/div/div/div/button[3]/a/span").getText();
    ...
    public void LogoutTest() {
        ...
        driverConfig.getDrivers().values().parallelStream().forEach(driver -> {
            ...
            //Logout
            getElementByXPath(driver, "//*[@id=\"profile-menu\"]").click();
            getElementByXPath(driver, "//*[@id=\"root\"]/div/div[1]/div/div[4]/div[3]/span/div/div/div/button[3]/a").click();
            //check logout
